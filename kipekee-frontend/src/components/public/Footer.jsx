      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            {status === "success" ? (
              <div className="bg-green-500/20 border border-green-500/50 text-green-300 p-4 rounded text-sm">
              ...
              >
                ...
                <button
                  ...
                  className="bg-brand-gold text-white font-bold py-3 rounded uppercase text-xs tracking-widest hover:bg-brand-goldHover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
